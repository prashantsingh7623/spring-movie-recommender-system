...
* The original package name 'com.spring.basics.spring-movie-recommender-system' is invalid and this project uses 'com.spring.basics.spring_movie_recommender_system' instead.
